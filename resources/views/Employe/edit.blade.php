                                        ...
                                        <form method ="POST" action="  {{route('Employe.update',['id' => $employe->id])}} " class="p-3" enctype="multipart/form-data">
                                          ...
                                          <div class="row">
                                              <div class="mb-3 col-12">
                                                  ...
                                                  <input type="text" class="form-control" id="exampleFormControlInput1" name="nom" value="{{$employe->nom}}">
                                              </div>
                                          </div>
                                          <div class="row">
                                              <div class="mb-3 col-12">
                                                  <label for="exampleFormControlInput1" class="form-label">Prénoms</label>
                                                  <input type="text" class="form-control" id="exampleFormControlInput1" name="prenom" value="{{$employe->prenom}}">
                                              </div>
                                          </div>
                                          <div class="row">
                                              <div class="mb-3 col-12">
                                                  <label for="exampleFormControlInput1" class="form-label">Numéro de téléphone</label>
                                                  <input type="number" class="form-control" id="exampleFormControlInput1" name="tel" value="{{$employe->tel}}">
                                              </div>
                                          </div>
                                          <div class="row">
                                              <div class="mb-3 col-12">
                                                  <label for="exampleFormControlInput1" class="form-label">Email</label>
                                                  <input type="email" class="form-control" id="exampleFormControlInput1" name="email" value="{{$employe->email}}">
                                              </div>
                                          </div>
                                          <div class="row">
                                          ...
                                          <div class="row">
                                              <div class="mb-3 col-12">
                                                  ...
                                                  <input type="text" class="form-control" id="exampleFormControlInput1" name="facebook" value='{{$employe->facebook}}'>
                                              </div>
                                          </div>
                                          <div class="row">
                                              <div class="mb-3 col-12">
                                                  <label for="exampleFormControlInput1" class="form-label">lien linkedln</label>
                                                  <input type="text" class="form-control" id="exampleFormControlInput1" name="linkedln" value='{{$employe->Linkedln}}'>
                                              </div>
                                          </div>
