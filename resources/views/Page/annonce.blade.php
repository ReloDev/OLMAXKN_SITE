                  ...
                  <article class="d-flex flex-column">
                    ...
                    <div class="meta-top">
                      <ul>
                        ...
                        <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href=" {{route('Annonce.detail',['id' => $annonce->id])}} "><time datetime="2022-01-01">{{$annonce->updated_at->format("F d,Y")}}</time></a></li>
              ...
              <div class="sidebar-item recent-posts">
                ...
                <div class="post-item mt-3">
                    ...
                    <div>
                      ...
                      <time datetime="2020-01-01">{{$annonce->created_at->format("F d,Y")}}</time>
                    </div>
