                    ...
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Formulaire de publication</h1>
                                    ...
                                    <form method ="POST" action="  {{route('Annonce.store')}} " class="p-3" enctype="multipart/form-data">
                                      @csrf
                                      <div class="row" id="n">
                                      ...
                                      <div class="mb-3 col-12">
                                                <span class=" fw-bold fs-6 text-secondary ">
                                                    Pour l'enregistrement des images vérifier bien que le type de fichier est "JPG" et veuillez à respecter pour chaque image enregistrer la taille de " 1024x768 "
                                                </span>
                                      </div>
                                      ...
                                      <div class="mb-3 col-12" id="p2">
                                        <label for="exampleFormControlInput1" class="form-label">Image</label><br>
                                                <div class="input-group mb-3">
                                                  <input type="file" class="form-control" id="inputGroupFile02" name="image" Value="null">
